...
/**
 * Servlet implementation class SamllSatServlet
 */
@WebServlet("/Small-Satellites")
public class SamllSatServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SamllSatServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Satellite> smallSatList = spaceAppService.getAllSmallSat();
